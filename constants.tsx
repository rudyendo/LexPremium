...
export const PECA_OPTIONS = [
  "Parecer Jurídico",
  "Mandado de Segurança",
  "Defesa Prévia",
  "Exceção de Pré-Executividade",
  "Embargos à Execução",
  "Requerimento de Revisão de Créditos",
  "Contranotificação / Manifestação",
  "Contrarrazões a Recurso Administrativo",
...
export const Icons = {
  ...
  Correspondence: (props: IconProps) => (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="20"
      height="20"
  ...
  Video: (props: IconProps) => (
    ...
    >
      ...
      {/* Top-Left Person rotated 120deg */}
      <g transform="rotate(120, 12, 12)">
        <path
          d="M 7.1 19 A 8.5 8.5 0 0 0 16.9 19"
          fill="none"
          stroke="currentColor"
          strokeWidth="2"
          strokeLinecap="round"
        />
        <circle cx="12" cy="21.5" r="1.6" fill="currentColor" />
      </g>

      {/* Top-Right Person rotated 240deg */}
  ...
  Flame: (props: IconProps) => (
    <svg
      ...
      {...props}
    >
      <path d="M8.5 14.5A2.5 2.5 0 0 0 11 12c0-1.38-.5-2-1-3-1.072-2.143-.224-4.054 2-6 .5 2.5 2 4.9 4 6.5 2 1.6 3 3.5 3 5.5a7 7 0 1 1-14 0c0-1.153.433-2.204 1.152-3.141C7 12 7.5 13.5 8.5 14.5Z" />
    </svg>
  ),
